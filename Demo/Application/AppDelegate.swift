...
extension AppDelegate {
    ...
    // Show Toast
    static func showToast(message: String, isError: Bool = true) {
//        if isError {
//            ToastView.appearance().backgroundColor = UIColor.colorFromHex(hexString: "#cb473b")
//        } else {
//            ToastView.appearance().backgroundColor = UIColor.colorFromHex(hexString: "#7fc136")
//        }
